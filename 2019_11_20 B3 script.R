...
B3 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_20 B3.csv")
...
B3bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_20 B3bkgd.csv")
B3bkgd = B3bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
