...
C3 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_6 C3.csv")
...
C3bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_6 C3bkgd.csv")
C3bkgd = C3bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
