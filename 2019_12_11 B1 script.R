...
B1 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_11 B1.csv")
...
B1bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_11 B1bkgd.csv")
B1bkgd = B1bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
