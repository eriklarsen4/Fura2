...
B2 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_10_30 B2.csv")
...
B2bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_10_30 B2bkgd.csv")
B2bkgd = B2bkgd[,-5]
...
exposure_frame = cbind(c(1, 8, 28, 53, 73, 99, 124, 148), c(8, 28, 53, 73, 99, 124, 158, 168))
...
response_frame = cbind(c(9,54,100,149), c(53,99,148,168))
  ## Rename the start and end columns
