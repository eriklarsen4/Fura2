...
A1 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_13 A1.csv")
...
A1bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_13 A1bkgd.csv")
...
exposure_frame = cbind(c(1, 15, 45, 75, 105, 135), c(15, 45, 75, 105, 135, 145))
...
response_frame = cbind(c(16,76,136), c(75,135,145))
  ## Rename the start and end columns
