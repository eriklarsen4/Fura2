...
B3 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_11 B3.csv")
...
B3bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_11 B3bkgd.csv")
B3bkgd = B3bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
...
exposure_frame = cbind(c(1, 15, 45, 75, 105, 135), c(15, 45, 75, 105, 135, 160))
...
response_frame = cbind(c(16,76,136), c(75,135,160))
  ## Rename the start and end columns
