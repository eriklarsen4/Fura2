...
A3 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_11 A3.csv")
...
A3bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_11 A3bkgd.csv")
A3bkgd = A3bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
...
agonist = c("Ringer's", "2.5uM LY344864", "Ringer's", "200uM AITC", "Ringer's", "HiK")
