...
B3 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_13 B3.csv")
...
B3bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_13 B3bkgd.csv")
B3bkgd = B3bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
...
Greenbkgd = Greenbkgd[-c(128:137),-1]
Redbkgd = Redbkgd[-c(128:137),-1]
...
exposure_frame = cbind(c(1, 15, 45, 75, 105, 130), c(15, 45, 75, 105, 130, 140))
...
response_frame = cbind(c(16,76,131), c(75,130,140))
  ## Rename the start and end columns
