...
A4 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_8 A4.csv")
...
A4bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_8 A4bkgd.csv")
A4bkgd = A4bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
