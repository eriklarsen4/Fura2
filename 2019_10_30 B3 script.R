...
B3 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_10_30 B3.csv")
...
B3bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_10_30 B3bkgd.csv")
B3bkgd = B3bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
...
agonist = c("Ringer's", "2.5uM LY344864", "Ringer's", "25uM CYM5442", "Ringer's", "5mM B-Ala", "Ringer's", "1uM Cap", "Ringer's", "HiK")
...
response_frame = cbind(c(9,59,104,149,189), c(58,103,148,188,213))
  ## Rename the start and end columns
...
Agonists_df = data.frame(c(agonist[seq(2,length(agonist),2)]), c(0.10, 0.10, 0.10, 0.10, 0.10))
  ## Rename the columns
