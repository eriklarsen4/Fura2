...
C1 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_6 C1.csv")
...
C1bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_6 C1bkgd.csv")
C1bkgd = C1bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
