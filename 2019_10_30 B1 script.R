...
B1 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_10_30 B1.csv")
...
B1bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_10_30 B1bkgd.csv")
B1bkgd = B1bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
...
agonist = c("Ringer's", "25uM CYM5442", "Ringer's", "5mM B-Ala", "Ringer's", "1uM Cap", "Ringer's", "HiK")
  ## Create a matrix containing the frame number at which the agonist was added and turned off
exposure_frame = cbind(c(1, 15, 35, 65, 85, 115, 135, 165), c(15, 35, 65, 85, 115, 135, 165, 180))
...
response_frame = cbind(c(16,66,116,166), c(65,115,165,180))
  ## Rename the start and end columns
