...
B1 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_11 B1.csv")
...
B1bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_11 B1bkgd.csv")
B1bkgd = B1bkgd[,-5]

  ## Replace NAs with the ROI# of each ROI
...
agonist = c("Ringer's", "25uM CYM5442", "Ringer's", "1uM Cap", "Ringer's", "HiK")

  ## Create a matrix containing the frame number at which the agonist was added and turned off
exposure_frame = cbind(c(1, 13, 43, 73, 103, 133), c(13, 43, 73, 103, 133, 148))
...
response_frame = cbind(c(14,74,134), c(73,133,148))
  ## Rename the start and end columns
