...
C1 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_10_30 C1.csv")
...
C1bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_10_30 C1bkgd.csv")
C1bkgd = C1bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
...
exposure_frame = cbind(c(1, 13, 33, 53, 73, 93, 113, 133), c(13, 33, 53, 73, 93, 113, 133, 148))
...
response_frame = cbind(c(14,54,94,134), c(53,93,133,148))
  ## Rename the start and end columns
