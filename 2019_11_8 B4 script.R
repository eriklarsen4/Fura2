...
B4 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_8 B4.csv")
...
B4bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_8 B4bkgd.csv")
B4bkgd = B4bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
