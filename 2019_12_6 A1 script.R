...
A1 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_6 A1.csv")
...
A1bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_6 A1bkgd.csv")
A1bkgd = A1bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
...
agonist = c("Ringer's", "25uM CYM5442", "Ringer's", "200uM AITC", "Ringer's", "HiK")
