...
C2 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_6 C2.csv")
...
C2bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_6 C2bkgd.csv")
C2bkgd = C2bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
