...
A1 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_8 A1.csv")
...
A1bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_8 A1bkgd.csv")
A1bkgd = A1bkgd[,-5]
...
agonist = c("Ringer's", "200uM AITC", "Ringer's", "1uM Capsaicin", "Ringer's", "HiK")
