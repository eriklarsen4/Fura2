...
B4 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_10_30 B4early.csv")
...
agonist = c("Ringer's", "5mM B-Ala", "Ringer's", "2.5uM LY344864", "Ringer's", "25uM CYM5442", "Ringer's", "200uM AITC")
  ## Create a matrix containing the frame number at which the agonist was added and turned off
exposure_frame = cbind(c(1, 13, 33, 53, 73, 93, 113, 133), c(13, 33, 53, 73, 93, 113, 133, 137))
...
response_frame = cbind(c(14,54,94,134), c(53,93,133,137))
  ## Rename the start and end columns
