...
B2 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_11 B2.csv")
...
B2bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_11 B2bkgd.csv")
B2bkgd = B2bkgd[,-5]
