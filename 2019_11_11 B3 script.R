...
B3 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_11 B3.csv")
...
Green = Green[-c(1:2,109:110),-1]
Red = Red[-c(1:2,109:110),-1]
...
B3bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_11 B3bkgd.csv")
B3bkgd = B3bkgd[,-5]
...
Greenbkgd = Greenbkgd[-c(1:2,109:110),-1]
Redbkgd = Redbkgd[-c(1:2,109:110),-1]
...
agonist = c("Ringer's", "5mM B-Ala", "Ringer's", "1uM Cap", "Ringer's", "HiK")

  ## Create a matrix containing the frame number at which the agonist was added and turned off
exposure_frame = cbind(c(1, 13, 43, 73, 103, 133), c(13, 43, 73, 103, 133, 146))
...
response_frame = cbind(c(14,74,134), c(73,133,146))
  ## Rename the start and end columns
