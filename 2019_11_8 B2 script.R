...
B2 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_8 B2.csv")
...
B2bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_8 B2bkgd.csv")
B2bkgd = B2bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
...
agonist = c("Ringer's", "2.5uM LY344864", "Ringer's", "1uM Cap", "Ringer's", "HiK")
