...
B1 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_6 B1.csv")
...
Green = Green[-c(74:75),-1]
Red = Red[-c(74:75),-1]

  ## Save the time as a variable to add after computing the green/red ratio since
t = ((1:nrow(Green))*3 - 3)
...
B1bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_6 B1bkgd.csv")
B1bkgd = B1bkgd[,-5]
...
Greenbkgd = Greenbkgd[-c(74:75),-1]
Redbkgd = Redbkgd[-c(74:75),-1]
...
agonist = c("Ringer's", "25uM CYM5442", "Ringer's", "1uM Capsaicin", "Ringer's", "HiK")

  ## Create a matrix containing the frame number at which the agonist was added and turned off
exposure_frame = cbind(c(1, 15, 45, 73, 103, 133), c(15, 45, 73, 103, 133, 148))
...
response_frame = cbind(c(16,74,134), c(73,133,148))
  ## Rename the start and end columns
