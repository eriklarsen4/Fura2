...
B3 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_15 B3.csv")
...
B3bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_15 B3bkgd.csv")
B3bkgd = B3bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
...
agonist = c("Ringer's", "Second Ringer's", "Ringer's", "LY344864", "Ringer's", "25uM CYM5442", "Ringer's", "HiK")
  ## Create a matrix containing the frame number at which the agonist was added and turned off
exposure_frame = cbind(c(1, 13, 33, 53, 83, 113, 133, 153), c(13, 33, 53, 83, 113, 133, 153, 168))
...
response_frame = cbind(c(14,54,114,154), c(53,113,153,168))
  ## Rename the start and end columns
