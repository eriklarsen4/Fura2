...
A3 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_20 A3.csv")
...
A3bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_20 A3bkgd.csv")
A3bkgd = A3bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
