...
A4 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_15 A4.csv")
...
A4bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_15 A4bkgd.csv")
A4bkgd = A4bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
...
agonist = c("Ringer's", "5mM B-Ala", "Ringer's", "200uM AITC", "Ringer's", "HiK")
  ## Create a matrix containing the frame number at which the agonist was added and turned off
exposure_frame = cbind(c(1, 15, 45, 75, 105, 135), c(15, 45, 75, 105, 135, 155))
...
response_frame = cbind(c(16,76,136), c(75,135,155))
  ## Rename the start and end columns
