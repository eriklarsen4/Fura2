...
A1 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_4 A1.csv")
...
A1bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_12_4 A1bkgd.csv")
A1bkgd = A1bkgd[,-5]
...
agonist = c("Ringer's", "5mM Beta-Alanine", "Ringer's", "1uM Cap", "Ringer's", "HiK")
