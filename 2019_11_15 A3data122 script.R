...
A3data122 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_15 A3data122.csv")
  ## Remove the extra column
A3data122 = A3data122[,-5]
  ## Replace NAs with the ROI# for each ROI
A3data122[,1] = rep(1:max(A3data122$Field., na.rm = T), each = max(A3data122$Object.))
  ## Reshape the data into something that is usable for plotting for green
Green = reshape(data = A3data122, idvar = "Field.", timevar = "Object.", direction = "wide", drop = "MEAN_RED.1")
  ## Reshape the data into something that is usable for plotting for red
Red = reshape(data = A3data122, idvar = "Field.", timevar = "Object.", direction = "wide", drop = "MEAN_GREEN.1")
...
A3data122bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_15 A3data122bkgd.csv")
A3data122bkgd = A3data122bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
A3data122bkgd[,1] = rep(1:max(A3data122bkgd$Field., na.rm = T), each = max(A3data122bkgd$Object.))
  ## Reshape the data into something that is usable for plotting for green
Greenbkgd = reshape(data = A3data122bkgd, idvar = "Field.", timevar = "Object.", direction = "wide", drop = "MEAN_RED.1")
  ## Reshape the data into something that is usable for plotting for red
Redbkgd = reshape(data = A3data122bkgd, idvar = "Field.", timevar = "Object.", direction = "wide", drop = "MEAN_GREEN.1")
  ## Rename the "Fields" column to "t" (time)
names(Greenbkgd)[1] = "t"
names(Redbkgd)[1] = "t"
...
A3data122Green = Green - AvgGbkgd
A3data122Red = Red - AvgRbkgd
...
FLUO = A3data122Green/A3data122Red
...
agonist = c("Ringer's", "2.5uM LY344864", "Ringer's", "25uM CYM5442", "Ringer's", "HiK")
  ## Create a matrix containing the frame number at which the agonist was added and turned off
exposure_frame = cbind(c(1, 13, 33, 53, 73, 88), c(13, 33, 53, 73, 88, 108))
...
response_frame = cbind(c(14,54,89), c(53,88,108))
  ## Rename the start and end columns
