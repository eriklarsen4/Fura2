...
B4 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_20 B4.csv")
...
B4bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_20 B4bkgd.csv")
B4bkgd = B4bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
...
agonist = c("Ringer's", "2.5uM LY344862", "Ringer's", "200uM AITC", "Ringer's", "HiK")
