...
A4 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_10_30 A4.csv")
...
A4bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_10_30 A4bkgd.csv")
A4bkgd = A4bkgd[,-5]
  ## Replace NAs with the ROI# for each ROI
...
agonist = c("Ringer's", "2.5uM LY344864", "Ringer's", "25uM CYM5442", "Ringer's", "200uM AITC", "Ringer's", "HiK")
  ## Create a matrix containing the frame number at which the agonist was added and turned off
exposure_frame = cbind(c(1, 13, 33, 64, 93, 123, 153, 173), c(13, 33, 64, 93, 123, 153, 173, 193))
...
response_frame = cbind(c(14,65,124,174), c(64,123,173,193))
  ## Rename the start and end columns
...
Agonists_df = data.frame(c(agonist[seq(2,length(agonist),2)]), c(0.10, 0.10, 0.10, 0.10))
  ## Rename the columns
