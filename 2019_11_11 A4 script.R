...
A4 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_11 A4.csv")
...
A4bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/Paper Data Copies/2019_11_11 A4bkgd.csv")
A4bkgd = A4bkgd[,-5]
...
agonist = c("Ringer's", "2.5uM LY344864", "Ringer's", "25uM CYM5442", "Ringer's", "1uM Cap", "Ringer's", "HiK")

  ## Create a matrix containing the frame number at which the agonist was added and turned off
exposure_frame = cbind(c(1, 13, 43, 73, 103, 133, 153, 173), c(13, 43, 73, 103, 133, 153, 173, 188))
...
response_frame = cbind(c(14,74,134,174), c(73,133,173,188))
  ## Rename the start and end columns
